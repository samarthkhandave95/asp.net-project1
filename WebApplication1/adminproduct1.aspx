<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="adminproduct1.aspx.cs" Inherits="WebApplication1.adminproduct1" %>
...
<asp:Button ID="bt2" ser
                  ...
                  <div class="row">
                     <div class="col-2">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-success" runat="server" Text="Add" CssClass="auto-style2" />
                         <br />
                         <br />
                     </div>
                     <div class="col-2">
                     ...
                     <div class="col-2">
                        <asp:Button ID="Button4" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete" CssClass="auto-style2" />
                         <br/>
                         <br />
                     </div>
                  </div>
